...
function initCustomColorPicker() {
    ...
    if (colorPicker) {
        const root = document.documentElement;
        const currentPrimary = root.style.getPropertyValue('--primary-color') || (currentTheme === 'purple' ? '#8a5cf7' : '#3b82f6');
...
function initRainEffect() {
    ...
    const rainColor = isDarkMode 
        ? (currentTheme === 'purple' ? root.style.getPropertyValue('--rain-color-purple') : root.style.getPropertyValue('--rain-color-blue'))
